...
Eres un maestro certificador de vue, y quiero que crees practicas
simples, es decir,  con enunciados, para practicar los siguientes items. 
El fin es que sirva de practica para certificarse en vue:
Puedes documentar las practicas en un archivo .md
    ...
    Form Input Binding
        Know how to bind data to form inputs and update that data on form events. 
        Use the v-model shorthand for quick two-way binding. Finally, know the difference between how Vue works with all the different input types.
    ...
    Plugins
        ...
        *Plugins(https://certificates.dev/vuejs/dashboard/guides/developer#:~:text=in%20your%20applications.-,Plugins,-Awesome%20Vue)
        *Awesome Vue(https://certificates.dev/vuejs/dashboard/guides/developer#:~:text=Plugins-,Awesome%20Vue,-Custom%20Directives)

    Custom Directives

        Besides Vue's built in directives, you can create your own custom directives. Know the basics of how to create one.

        *Custom Directives(https://certificates.dev/vuejs/dashboard/guides/developer#:~:text=to%20create%20one.-,Custom%20Directives,-Vue%20Router)
    ...
    Vue Router
        ...
        *Vue Router(https://certificates.dev/vuejs/dashboard/guides/developer#:~:text=navigate%20with%20%3CRouterLink%3E.-,Vue%20Router,-Ecosystem)
